...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(Object.keys(objetoRetornado2.fetchMenu())).toEqual([ 'food', 'drink']); // Retorno: { food: {}, drink: {}}
    ...
    expect(objetoRetornado3.fetchMenu()).toMatchObject({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    ...
    expect(objetoRetornado4.consumption).toEqual([]); // Retorno: []
    // ```
    ...
    expect(objetoRetornado5.consumption).toEqual(["coxinha"]); // Retorno: ["coxinha"]
    // ```
    ...
    expect(objetoRetornado6.consumption).toEqual(["coxinha", "agua", "sopa", "sashimi"]) // Retorno: 
    // ```
    ...
    objetoRetornado7.order('coxinha');
    expect(objetoRetornado7.consumption).toEqual(['coxinha', 'agua', 'coxinha']) // Retorno: ['coxinha', 'agua', 'coxinha']
    // ```
    ...
    expect(objetoRetornado8.pay()).toEqual((3.9 + 3.9 + 3.9)*1.1) // Retorno: somaDosPreçosDosPedidos
    // ```
